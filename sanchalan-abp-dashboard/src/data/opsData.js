// SANCHALAN — mock operational data
...
// start/dur in hours from Monday 00:00 (one week = 168h)
...
export const KPIS = [
  { label: 'Block-hours secured this week', man: 1240, ai: 1890, fmt: (v) => Math.round(v).toLocaleString('en-IN'), delta: '+52% throughput', good: true },
  { label: 'Overdue defects cleared', man: 34, ai: 78, fmt: (v) => Math.round(v) + '%', delta: '+44 pts', good: true },
  { label: 'Cross-dept conflicts auto-resolved', man: 0, ai: 63, fmt: (v) => Math.round(v), delta: 'vs 0 manual', good: true },
  { label: 'Asset availability (rolling stock)', man: 71, ai: 92, fmt: (v) => Math.round(v) + '%', delta: '+21 pts', good: true },
];
